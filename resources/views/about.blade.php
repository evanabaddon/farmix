...
<section class="about-layout1 space-top">
    <div class="container">
        <div class="row gx-5 justify-content-end">
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="https://html.vecurosoft.com/farmix/demo/assets/img/about/about-1-1.jpg" alt="about-image">
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="auther-info">
                    ...
                    <div class="author-signature">
                        <img src="https://html.vecurosoft.com/farmix/demo/assets/img/about/about-signature.png" alt="about-signature">
                    </div>
                </div>
            </div>
            <div class="col-xl-10 col-lg-12 col-md-12">
                <div class="about-bottom">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="item-img">
                                <img src="https://html.vecurosoft.com/farmix/demo/assets/img/about/about-1-2.jpg" alt="about img">
                        ...
                        <div class="col-lg-4">
                            <div class="about-style1 border1">
                                <div class="about-inner">
                                    <div class="about-icon"><img src="https://html.vecurosoft.com/farmix/demo/assets/img/icon/about-icon-1-1.png" alt="icon"></div>
                                    <h3 class="about-title"><a href="{{ route('service-details') }}">100% Guaranteed Organic Product</a></h3>
                        ...
                        <div class="col-lg-4">
                            <div class="about-style1">
                                <div class="about-inner">
                                    <div class="about-icon"><img src="https://html.vecurosoft.com/farmix/demo/assets/img/icon/about-icon-1-2.png" alt="icon"></div>
                                    <h3 class="about-title"><a href="{{ route('service-details') }}">Top-Quality Healthy Foods Production</a></h3>
                                    <p class="about-text">Lorem ipsum dolor sit amet, porro quisquam est, qui.</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row vs-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-autoplay="true" data-arrows="true">
            <div class="col-lg-3">
                <div class="process-style1">
                    <div class="process-img">
                        <img src="https://html.vecurosoft.com/farmix/demo/assets/img/process/process-1-1.png" alt="process-image">
                    </div>
                    <div class="process-content">
                        <h3 class="process-title h5"><a href="{{ route('service-details') }}">Our Plan</a></h3>
            ...
            <div class="col-lg-3">
                <div class="process-style1">
                    <div class="process-img">
                        <img src="https://html.vecurosoft.com/farmix/demo/assets/img/process/process-1-2.png" alt="process-image">
                    </div>
                    <div class="process-content">
                        <h3 class="process-title h5"><a href="{{ route('service-details') }}">Expert Farmer</a></h3>
                        <p class="process-text">Veritatis eligendi, dignissimo fermentum mus aute pulvinar platea massa rutrum.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="process-style1">
                    <div class="process-img">
                        <img src="https://html.vecurosoft.com/farmix/demo/assets/img/process/process-1-3.png" alt="process-image">
                    </div>
                    <div class="process-content">
                        <h3 class="process-title h5"><a href="{{ route('service-details') }}">Quality Pdoduct</a></h3>
                        <p class="process-text">Veritatis eligendi, dignissimo fermentum mus aute pulvinar platea massa rutrum.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="process-style1">
                    <div class="process-img">
                        <img src="https://html.vecurosoft.com/farmix/demo/assets/img/process/process-1-4.png" alt="process-image">
                    </div>
                    <div class="process-content">
                        <h3 class="process-title h5"><a href="{{ route('service-details') }}">We Deliver</a></h3>
                        <p class="process-text">Veritatis eligendi, dignissimo fermentum mus aute pulvinar platea massa rutrum.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="process-style1">
                    <div class="process-img">
                        <img src="https://html.vecurosoft.com/farmix/demo/assets/img/process/process-1-5.png" alt="process-image">
                    </div>
                    <div class="process-content">
                        <h3 class="process-title h5"><a href="{{ route('service-details') }}">More Plan</a></h3>
                        <p class="process-text">Veritatis eligendi, dignissimo fermentum mus aute pulvinar platea massa rutrum.</p>
                    </div>
                </div>
            </div>
...
History Area
============================== -->
<section class="history-layout1 space" data-bg-src="https://html.vecurosoft.com/farmix/demo/assets/img/bg/history-bg-1.jpg">
    <div class="container">
        <div class="title-area wow fadeInUp wow-animated" data-wow-delay="0.3s">
...
Counter Area
============================== -->
<section class="counter-layout1 space"  data-bg-src="https://html.vecurosoft.com/farmix/demo/assets/img/bg/counter-bg.jpg">
    <div class="container">
                ...
                <div class="media-style">
                    <div class="media-inner">
                        <div class="media-icon">
                            <div class="icon">
                                <img src="https://html.vecurosoft.com/farmix/demo/assets/img/icon/counter-icon1.png" alt="counter-icon">
                            </div>
                        </div>
            ...
            <div class="col-xl-auto col-lg-4 col-md-6">
                <div class="media-style">
                    <div class="media-inner">
                        <div class="media-icon">
                            <div class="icon">
                                <img src="https://html.vecurosoft.com/farmix/demo/assets/img/icon/counter-icon2.png" alt="counter-icon">
                            </div>
                        </div>
                        <div class="media-counter">
                            <div class="media-count">
            ...
            <div class="col-xl-auto col-lg-4 col-md-6">
                <div class="media-style">
                    <div class="media-inner">
                        <div class="media-icon">
                            <div class="icon">
                                <img src="https://html.vecurosoft.com/farmix/demo/assets/img/icon/counter-icon3.png" alt="counter-icon">
                            </div>
                        </div>
                        <div class="media-counter">
                            <div class="media-count">
            ...
            <div class="col-xl-auto col-lg-4 col-md-6">
                <div class="media-style">
                    <div class="media-inner">
                        <div class="media-icon">
                            <div class="icon">
                                <img src="https://html.vecurosoft.com/farmix/demo/assets/img/icon/counter-icon4.png" alt="counter-icon">
                            </div>
                        </div>
                        <div class="media-counter">
                            <div class="media-count">
...
<section class="testimonial-layout1 space">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="vs-carousel" data-arrows="false" data-center-mode="left" data-dots="true" data-autoplay="true" data-slide-show="1">
                    <div class="testi-style1">
                        <div class="auther-inner">
                            <div class="auther-img">
                                <img src="https://html.vecurosoft.com/farmix/demo/assets/img/testimonial/testi-img-1-1.png" alt="testimonial">
            ...
            <div class="col-lg-6">
                <div class="testi-img">
                    <img src="https://html.vecurosoft.com/farmix/demo/assets/img/testimonial/testi-img.png" alt="testimonial">
                </div>
            </div>
        </div>
    </div>
